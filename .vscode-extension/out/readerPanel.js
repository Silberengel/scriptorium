...
class ReaderPanel {
    static createOrShow(extensionPath) {
        ...
        const panel = vscode.window.createWebviewPanel(ReaderPanel.viewType, 'Scriptorium Reader', column || vscode.ViewColumn.One, {
            enableScripts: true,
            localResourceRoots: [
    ...
    async readPublication(eventRef, relayUrl) {
        this._panel.webview.postMessage({
            type: 'status',
        ...
        try {
            ...
            const pythonCmd = await (0, extension_1.findPythonCommand)();
            const env = { ...process.env };
            // Use spawn to stream output line-by-line
            const pythonProcess = (0, child_process_1.spawn)(pythonCmd, [
...
ReaderPanel.viewType = 'scriptoriumReader';
//# sourceMappingURL=readerPanel.js.map