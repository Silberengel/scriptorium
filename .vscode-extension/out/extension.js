...
function activate(context) {
    ...
    context.subscriptions.push(openPanelCommand, openSettingsCommand, initMetadataCommand, generateCommand, publishCommand, qcCommand, allCommand, broadcastCommand, deleteCommand);
}
