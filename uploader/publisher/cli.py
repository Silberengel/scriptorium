...
def build_parser() -> argparse.ArgumentParser:
    ...
    sp = sub.add_parser(
        ...
        description=(
            ...
            "  - Collection root (kind 30040): title, author, publisher, published_on, published_by, summary, type, auto-update, source, image (if specified), p and E (for derivative works)\n"
            "  - Book/Chapter indexes (kind 30040): type, book, chapter, version (if use_bookstr enabled), auto-update\n"
